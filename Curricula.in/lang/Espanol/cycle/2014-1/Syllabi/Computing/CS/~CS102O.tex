...
\begin{unit}{\ALFundamentalAlgorithmsDef}{Stroustrup97}{3}{3}
    \ALFundamentalAlgorithmsAllTopics
    \ALFundamentalAlgorithmsAllObjectives
\end{unit}

\begin{unit}{\PLVirtualMachinesDef}{Stroustrup97, Meyer98}{2}{2}
    \PLVirtualMachinesAllTopics
    \PLVirtualMachinesAllObjectives
\end{unit}

\begin{unit}{\PLDeclarationsAndTypesDef}{Meyer98}{2}{3}
    \PLDeclarationsAndTypesAllTopics
    \PLDeclarationsAndTypesAllObjectives
\end{unit}

\begin{unit}{\PLAbstractionMechanismsDef}{Stroustrup97}{5}{3}
    \PLAbstractionMechanismsAllTopics
    \PLAbstractionMechanismsAllTopics
\end{unit}

\begin{unit}{\PLObjectOrientedProgrammingDef}{Stroustrup97, Meyer98}{7}{3}
    \PLObjectOrientedProgrammingAllTopics
    \PLObjectOrientedProgrammingAllObjectives
\end{unit}

\begin{unit}{\SESoftwareDesignDef}{Stroustrup97}{5}{2}
   \begin{topics}
...
\begin{unit}{\SEUsingAPIsDef}{Stroustrup97}{1}{1}
   \SEUsingAPIsAllTopics
   \SEUsingAPIsAllObjectives
\end{unit}

\begin{unit}{\SERequirementsSpecificationsDef}{Stroustrup97}{1}{1}
   \begin{topics}
...
\begin{unit}{\SESoftwareValidationDef}{Stroustrup97}{2}{1}
   \begin{topics}
   	\item \SESoftwareValidationTopicTesting
	\item \SESoftwareValidationTopicObject
   \end{topics}
   \begin{unitgoals}
   	\item \SESoftwareValidationObjONE
	\item \SESoftwareValidationObjTWO
	\item \SESoftwareValidationObjSIX
   \end{unitgoals}
\end{unit}
