...
\begin{unit}{Conocimiento e Investigación}{Aguilar92}{5}{1}
   \begin{topics}
...
\begin{unit}{Diferencia entre Método y Técnica}{Gutierrez88}{5}{1}
   \begin{topics}
...
\begin{unit}{Las técnicas de Investigación}{Arias99}{5}{1}
   \begin{topics}
...
\begin{unit}{El proceso de investigación}{Pardinas94}{10}{1}
   \begin{topics}
