...
\textbf{\arabic{SyllabusSectionCount}.1 CARRERA PROFESIONAL}     & : & Informática        \\
...
\textbf{\arabic{SyllabusSectionCount}.5 CARACTER}                & : & --COURSE_TYPE--           \\ 
\textbf{\arabic{SyllabusSectionCount}.6 HORAS}                   & : & --HOURS--          \\ 
\textbf{\arabic{SyllabusSectionCount}.7 CREDITOS}                & : & --CREDITS--       \\ 	\hline
\end{tabularx}
\end{center}
...
\begin{center}
\begin{tabularx}{\textwidth}{|X|}      \hline
\textbf{\arabic{SyllabusSectionCount}. FUNDAMENTACION DEL CURSO}        \\ \hline
--JUSTIFICATION--                  \\ \hline
\end{tabularx}
\end{center}
