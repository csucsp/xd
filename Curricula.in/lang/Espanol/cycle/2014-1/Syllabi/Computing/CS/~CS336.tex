...
%1
\begin{unit}{\PFFoundationsInformationSecurityDef}{Password95DOD,Spafford98InternetWorm,Computer89Tinto,Computer91Russel,Structured95Olovsson}{4}{1}
    \PFFoundationsInformationSecurityAllTopics
    \PFFoundationsInformationSecurityAllObjectives
\end{unit}

%2
\begin{unit}{\PFSecureProgrammingDef}{Aplicaciones99Ramio}{4}{1}
    \PFSecureProgrammingAllTopics
    \PFSecureProgrammingAllObjectives
\end{unit}

%3
\begin{unit}{\OSSecurityModelsDef}{Aplicaciones99Ramio}{4}{1}
    \OSSecurityModelsAllTopics
    \OSSecurityModelsAllObjectives
\end{unit}

%4
\begin{unit}{\ALCryptographicAlgorithmsDef}{Aplicaciones99Ramio, Cryptography99Stalling, Cryptography89Seberry, Introduccion96Caballero, Tecnicas97Fuster}{4}{1}
    \ALCryptographicAlgorithmsAllTopics
    \ALCryptographicAlgorithmsAllObjectives
\end{unit}

%5
\begin{unit}{\NCNetworkSecurityDef}{Security89Bellovin, Guideline94FIPS, Network95William, Introduction98ICSA, Kerberos94Clifford}{8}{1}
    \NCNetworkSecurityAllTopics
    \NCNetworkSecurityAllObjectives
\end{unit}

%6
\begin{unit}{\NCNetworkManagementDef}{Password95DOD,Guide87NCSC,Authentication94Ravi,Venerma98TCPWrapper}{8}{1}
    \NCNetworkManagementAllTopics
    \NCNetworkManagementAllObjectives
\end{unit}

%7
\begin{unit}{\HCHumanFactorsAndSecurityDef}{Pautas98Cano}{2}{1}
    \HCHumanFactorsAndSecurityAllTopics
    \HCHumanFactorsAndSecurityAllObjectives
\end{unit}

%8
\begin{unit}{\SPSecurityOperationsDef}{Aplicaciones99Ramio}{8}{1}
    \SPSecurityOperationsAllTopics
    \SPSecurityOperationsAllObjectives
\end{unit}

%9
\begin{unit}{\PLVirtualMachinesDef}{Aplicaciones99Ramio}{3}{1}
\begin{topics}
