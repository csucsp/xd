...
\begin{unit}{\PLVirtualMachinesDef}{Lou004CO,Pratt98,Aho90}{8}{2}
   \PLVirtualMachinesAllTopics
   \PLVirtualMachinesAllObjectives
\end{unit}

\begin{unit}{\PLBasicLanguageTranslationDef}{Aho2008,Aho90,Teu98,Lou004CO,Appe002}{12}{1}
   \PLBasicLanguageTranslationAllTopics
   \PLBasicLanguageTranslationAllObjectives
\end{unit}

\begin{unit}{\PLLanguageTranslatioSystemsDef}{Aho2008,Aho90,Lou004CO,Teu98,Lem96,Appe002}{24}{1}
   \PLLanguageTranslatioSystemsAllTopics
   \PLLanguageTranslatioSystemsAllObjectives
\end{unit}

\begin{unit}{Paralelismo a nivel de instrucción}{Aho2008}{4}{1}
  \begin{topics}
...
\begin{unit}{Optimización para el paralelismo y la localidad}{Aho2008}{4}{1}
  \begin{topics}
