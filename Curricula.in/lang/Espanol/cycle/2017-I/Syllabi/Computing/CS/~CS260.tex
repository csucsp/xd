...
\begin{unit}{Lógica de Predicados de Primer Orden}{Iranzo05,Paniagua03}{20}{1}
   \begin{topics}
...
\begin{unit}{Intensificación en Programación}{Lloyd93, Bratko91}{20}{1}
   \begin{topics}
         \item Progamación Lógica
         \item Progamación Lógica Avanzada
...
\begin{unit}{Extensiones y otras Lógicas}{Fernandez03, Klir95}{20}{1}
   \begin{topics}
