...
\begin{unit}{El Clasicismo}{Jackson,Riquer}{0}{2}
\begin{topics}
...
\end{unitgoals}
\end{unit}
\begin{unit}{Literatura Medieval}{Jackson,Riquer}{0}{2}
\begin{topics}
...
\begin{unit}{El Romanticismo}{Jackson,Riquer}{0}{2}
\begin{topics}
	\item Goethe ``Werther''
...
\begin{unit}{El Modernismo}{Jackson,Riquer}{0}{2}
\begin{topics}
	\item Rubén Darío
...
\end{unitgoals}
\end{unit}
\begin{unit}{Narrativa del Siglo XX}{Jackson,Riquer}{0}{1}
\begin{topics}
...
\end{unitgoals}
\end{unit}
\begin{unit}{Lectura}{Jackson,Riquer}{0}{1}
\begin{topics}
