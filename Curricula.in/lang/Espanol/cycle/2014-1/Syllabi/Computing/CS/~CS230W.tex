...
\begin{unit}{\NCIntroductionDef}{Stalling05,Tanenbaum05,Cisco04,Wasserman08,McNab08,Gast08}{12}{1}
   \NCIntroductionAllTopics
   \NCIntroductionAllObjectives
\end{unit}

\begin{unit}{\NCNetworkCommunicationDef}{Stalling05,Stevens05,Tanenbaum05,Gast08}{12}{1}
   \NCNetworkCommunicationAllTopics
   \NCNetworkCommunicationAllObjectives
\end{unit}

\begin{unit}{\NCCompressionDef}{Stalling05}{10}{1}
	\NCCompressionAllTopics
	\NCCompressionAllObjectives
\end{unit}

\begin{unit}{NC/Tecnologias de Redes Locales}{Cisco04,Stevens06,Wasserman08,Gast08,McNab08}{16}{1}
   \begin{topics}
