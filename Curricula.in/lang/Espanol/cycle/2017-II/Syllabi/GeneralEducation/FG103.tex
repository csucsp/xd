...
\begin{goals}
\item Canalizar las inquietudes y anhelos del alumno a través del descubrimiento y encuentro de sí mismo, que le brinden espacios de análisis y reflexión personal para asumir posturas bien fundamentadas hacia los valores e ideales de su entorno y lograr una disposición de apertura a su propio mundo interior y a su misión, cuestionando su cosmovisión para obtener un conocimiento y crecimiento personal que permitan su despliegue integral y profesional. 
\end{goals}
...
\begin{unit}{La experiencia existencial y el descubrimiento del sentido de la vida}{La experiencia existencial y el descubrimiento del sentido de la vida}{Sanz,Rilke,Marias,Frankl}{24}{C20}
\begin{topics}
...
\begin{learningoutcomes}
	...
	\item Identificar el anhelo de sentido que pervive en toda persona humana.[\Usage].
\end{learningoutcomes}
\end{unit}

\begin{unit}{Visión sobre la persona humana}{Visión sobre la persona humana}{Guardini,Fromm,Vergara,Pieper}{18}{C20, C21}
\begin{topics}
	\item Misterio de la persona: ¿Quién soy? Las preguntas fundamentales.
	\item El hombre como unidad y anhelo de trascendencia.
...
\begin{unit}{Vida Universitaria y Horizontes de Misión}{Vida Universitaria y Horizontes de Misión}{JuanPablo,Guardini2,Identidad}{3}{C20, C21}
\begin{topics}
