...
\begin{unit}{El accionar empresarial del siglo XXI}{Castells01}{8}{1}
   \begin{topics}
...
\begin{unit}{La nueva economía desde una perspectiva macroeconómica}{Barea00}{10}{1}
   \begin{topics}
...
\begin{unit}{Bienes y servicios de la nueva economía}{Tapscott01}{10}{1}
   \begin{topics}
...
\begin{unit}{El destino de las firmas}{Alvarez01}{10}{1}
   \begin{topics}
      \item El surgimiento de la economiía electro-autónoma
...
\begin{unit}{Negocios y gobiernos en la red}{Velasco02}{10}{1}
   \begin{topics}
