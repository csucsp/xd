...
\begin{unit}{\IMDataMiningDef}{tan05,witten01,han01,kimball04,inmon04,kimball05}{10}{1}
    \IMDataMiningAllTopics%
    \IMDataMiningAllObjectives%
\end{unit}

\begin{unit}{\IMInformationStorageAndRetrievalDef}{brusilovsky98,elmasri04}{10}{1}
    \IMInformationStorageAndRetrievalAllTopics%
    \IMInformationStorageAndRetrievalAllObjectives%
\end{unit}

\begin{unit}{\IMHypermidiaDef}{brusilovsky98,elmasri04}{10}{1}
    \IMHypermidiaAllTopics%
    \IMHypermidiaAllObjectives%
\end{unit}

\begin{unit}{\IMMultimediaSystemsDef}{elmasri04}{10}{1}
    \IMMultimediaSystemsAllTopics%
    \IMMultimediaSystemsAllObjectives%
\end{unit}

\begin{unit}{\IMDigitalLibrariesDef}{witten02,elmasri04}{10}{1}
