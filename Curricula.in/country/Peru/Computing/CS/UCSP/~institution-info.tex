...
\newcommand{\CurriculaVersion}{1\xspace}
...
\newcommand{\SchoolFullName}{Programa Profesional de Ciencia de la Computación (Informática)}
\newcommand{\SchoolFullNameBreak}{\FacultadName\\ Programa Profesional de \\Ciencia de la Computación \\ (Informática)\xspace}
...
\newcommand{\AbstractIntro}{Este documento representa el informe final de la nueva malla curricular \YYYY del \SchoolFullName de la \University (\textit{\InstitutionURL}) en la ciudad de \city-Perú. En la actualidad esta carrera está siendo orientada a \SchoolShortName, el Bachillerato ya
está con esta denominación y el título profesional ya fue cambiado a
Ciencia de la Computación en Consejo Universitario de fecha 14 de Octubre de 2010.}
