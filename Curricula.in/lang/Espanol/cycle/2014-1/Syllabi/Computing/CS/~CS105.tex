...
\begin{unit}{\DSFunctionsRelationsAndSetsDef}{Kolman97,Grassmann97,Johnsonbaugh99}{13}{1}
    \DSFunctionsRelationsAndSetsAllTopics
    \DSFunctionsRelationsAndSetsAllObjectives
\end{unit}

\begin{unit}{\DSBasicLogicDef}{Grassmann97,Iranzo05,Paniagua03,Johnsonbaugh99}{14}{1}
    \DSBasicLogicAllTopics
    \DSBasicLogicAllObjectives
\end{unit}

\begin{unit}{\DSProofTechniquesDef}{Scheinerman01,Brassard97,Kolman97,Johnsonbaugh99}{14}{1}
   \DSProofTechniquesAllTopics
   \DSProofTechniquesAllObjectives
\end{unit}

\begin{unit}{\ARDigitalLogicAndDataRepresentationDef}{Kolman97, Grimaldi97, Gersting87}{19}{1}
\begin{topics}
